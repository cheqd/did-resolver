...
TESTNET_DID_VERSION = TESTNET_DID + VERSION_PATH + TESTNET_DID_VERSION_ID
TESTNET_DID_VERSION_METADATA = TESTNET_DID + VERSION_PATH + TESTNET_DID_VERSION_ID + METADATA_PATH
