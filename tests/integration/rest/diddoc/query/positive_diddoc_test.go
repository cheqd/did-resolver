...
var _ = DescribeTable("Positive: Get DIDDoc", func(testCase utils.PositiveTestCase) {
	...
	// Entry(
	// 	"First VersionId (Should be with empty linkedResourceMetadata): can get DIDDoc with an existent UUID style testnet DID",
	// 	utils.PositiveTestCase{
	// 		DidURL: fmt.Sprintf(
	// 			"http://localhost:8080/1.0/identifiers/%s?versionId=%s",
	// 			SeveralVersionsDID,
	...
	// 		EncodingType:         testconstants.DefaultEncodingType,
	// 		ExpectedEncodingType: "gzip",
	// 		ExpectedJSONPath:     "../../testdata/diddoc/diddoc_uuid_testnet_several_versions_empty_resources.json",
	// 		ExpectedStatusCode:   http.StatusOK,
	// 	},
	// ),
)
